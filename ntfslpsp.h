...
typedef BOOL (WINAPI *pGetFileSizeEx)(IN HANDLE hFile, OUT PLARGE_INTEGER lpFileSize);
...
typedef DWORD (WINAPI *pGetMappedFileNameA)(IN HANDLE hProcess, IN LPVOID lpv, OUT LPSTR lpFilename, IN DWORD nSize);
typedef DWORD (WINAPI *pGetMappedFileNameW)(IN HANDLE hProcess, IN LPVOID lpv, OUT LPWSTR lpFilename, IN DWORD nSize);
typedef DWORD (WINAPI *pGetModuleFileNameExA)(IN HANDLE hProcess, IN HMODULE hModule, OUT LPSTR lpFilename, IN DWORD nSize);
typedef DWORD (WINAPI *pGetModuleFileNameExW)(IN HANDLE hProcess, IN HMODULE hModule, OUT LPWSTR lpFilename, IN DWORD nSize);
